...
public class ModelWriter2 {
    ...
    private static String createFullModel(int nodesQuantity, int linesQuantity) {
        ...
        final var nodesSet = NetworkParams2.writeSet("NODES", nodesQuantity, NODES_SYMBOL);
        final var linesSet = NetworkParams2.writeSet("LINES", linesQuantity, LINES_SYMBOL);
        final var lines_limit = NetworkParams2.writeParameter("line_limit", linesQuantity, LINES_SYMBOL);
        final var ptdfs = PowerTransferDistributionFactors.generatePTDFs(linesQuantity, nodesQuantity);
        final var nodesParameters = NetworkParams2.writeNodesParameters(nodesQuantity);
