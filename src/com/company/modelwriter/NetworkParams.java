...
public class NetworkParams {
    ...
    private static final int MAX_LINE_LIMIT = 100;
    ...
    private static final List<String> parametersNames = List.of("sell_price", "demand", "production_limit");
    ...
    public static String writeParameter(String name, int quantity, String symbol) {
        ...
        for (int i = 0; i < quantity; i++) {
            sb.append(DEFAULT_PARAM_SEPARATOR).append(symbol).append(i + 1).append("\t\t")
                    .append(String.format("%-8s", getRandomInteger(MIN_LINE_LIMIT, MAX_LINE_LIMIT)))
                    .append("\n");
        }
        sb.append("\t;\n");
        return sb.toString();
    ...
    public static String writeNodesParameters(int nodesQuantity) {
        ...
        for (int i = 0; i < nodesQuantity; i++) {
            ...
            sb.append(String.format(PARAMETERS_SPACE.get("sell_price"), getRandomInteger(MIN_SELL_PRICE, MAX_SELL_PRICE)));
            // append demand value
